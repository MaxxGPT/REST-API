    ...
    <div class="article-container">
        <article id="content">
            ...
            <section>
                ...
                <br />
                <h3 id="intellectual-property-rights"><a class="anchor" href="#intellectual-property-rights">Intellectual Property Rights</a></h3>
                <br />
                ...
                <br />
                <h3 id="user-representations"><a class="anchor" href="#user-representations">User Representations</a></h3>
                <br />
                ...
                <br />
                <h3 id="user-registration"><a class="anchor" href="#user-registration">User Registration</a></h3>
                <br />
                <p>You may be required to register with the Site. You agree to keep your password confidential and will be responsible for all use of your account and password. We reserve the right to remove, reclaim, or change a username you select if we determine, in our sole discretion, that such username is inappropriate, obscene, or otherwise objectionable.</p>
                <br />
                <h3 id="fees-and-payments"><a class="anchor" href="#fees-and-payments">Fees and Payment</a></h3>
                <br />
                <p>We accept the following forms of payment:</p>
                <br />
                <p>You may be required to purchase or pay a fee to access some of our services. You agree to provide current, complete, and accurate purchase and account information for all purchases made via the Site. You further agree to promptly update account and payment information, including email address, payment method, and payment card expiration date, so that we can complete your transactions and contact you as needed. We bill you through an online billing account for purchases made via the Site. Sales tax will be added to the price of purchases as deemed required by us. We may change prices at any time. All payments shall be in US Dollars.</p>
                <br />
                ...
                <br />
                <h3 id="cancellation"><a class="anchor" href="#cancellation">Cancellation</a></h3>
                <br />
                <p>You can cancel your subscription at any time. Your cancellation will take effect at the end of the current paid term. </p>
                <br />
                <p>If you are unsatisfied with our services, please email us at contact@asatera.com.</p>
                <br />
                <h3 id="prohibited-activities"><a class="anchor" href="#prohibited-activities">Prohibted Activities</a></h3>
                <br />
                ...
                <br />
                <p>Contributions may be viewable by other users of the Site and through third-party websites. As such, any Contributions you transmit may be treated in accordance with the Site Privacy Policy. When you create or make available any Contributions, you thereby represent and warrant that:</p>
                <br />
                <ul>
                ...
                <br />
                <h3 id="social-media"><a class="anchor" href="#social-media">Social Media</a></h3>
                <br />
                <p>As part of the functionality of the Site, you may link your account with online accounts you have with third-party service providers (each such account, a “Third-Party Account”) by either: (1) providing your Third-Party Account login information through the Site; or (2) allowing us to access your Third-Party Account, as is permitted under the applicable Terms of Service that govern your use of each Third-Party Account.</p>
                <br />
                <p>You represent and warrant that you are entitled to disclose your Third-Party Account login information to us and/or grant us access to your Third-Party Account, without breach by you of any of the Terms of Service that govern your use of the applicable Third-Party Account, and without obligating us to pay any fees or making us subject to any usage limitations imposed by the third-party service provider of the Third-Party Account.</p>
                <br />
                ...
                <h3 id="submissions"><a class="anchor" href="#submissions">Submissions</a></h3>
                <br />
                ...
                <h3 id="third-party-websites-and-content"><a class="anchor" href="#third-party-websites-and-content">Third-Party Websites and Content</a></h3>
                <br />
                ...
                <br />
                <p>Inclusion of, linking to, or permitting the use or installation of any Third-Party Websites or any Third-Party Content does not imply approval or endorsement thereof by us. If you decide to leave the Site and access the Third-Party Websites or to use or install any Third-Party Content, you do so at your own risk, and you should be aware these Terms of Service no longer govern.</p>
                <br />
                ...
                <h3 id="site-management"><a class="anchor" href="#site-management">Site Management</a></h3>
                <br />
                ...
                <h3 id="dmca"><a class="anchor" href="#dmca">Digital Millennium Copyright Act (DMCA) Notice and Policy</a></h3>
                <br />
                <h4> Notifications</h4>
                <br />
                ...
                <br />
                <p>A copy of your Notification will be sent to the person who posted or stored the matAll Notifications should meet the requirements of DMCA 17 U.S.C. § 512(c)(3) and include the following information:</p>
                <br />
                ...
                <p>A copy of your Notification will be sent to the person who posted or stored the material addressed in the Notification. Please be advised that pursuant to federal law you may be held liable for damages if you make material misrepresentations in a Notification. Thus, if you are not sure that material located on or linked to by the Site infringes your copyright, you should consider first contacting an attorney.</p>
                <br />
                <h3 id="counter-notification"><a class="anchor" href="#counter-notification">Counter Notification</a></h3>
                <br />
                ...
                <br />
                <h3 id="copyright-infringements"><a class="anchor" href="#copyright-infringements">Copyright Infringements</a></h3>
                <br />
                ...
                <br />
                <h3 id="terms-and-termination"><a class="anchor" href="#terms-and-termination">Terms and Termination</a></h3>
                <br />
                ...
                <br />
                <h3 id="modifications-and-interruptions"><a class="anchor" href="#modifications-and-interruptions">Modifications and Interruptions</a></h3>
                <br />
                ...
                <h3 id="governing-law"><a class="anchor" href="#governing-law">Governing Law</a></h3>
                <br />
                <p>These Terms of Service and your use of the Site are governed by and construed in accordance with the laws of the State of Delaware applicable to agreements made and to be entirely performed within the State/Commonwealth of [name of state], without regard to its conflict of law principles.</p>
                <br />
                
                
                <h3 id="dispute-resolution"><a class="anchor" href="#dispute-resolution">Dispute Resolution</a></h3>
                <br />
                ...
                <br />
                <p>Application of the United Nations Convention on Contracts for the International Sale of Goods and the Uniform Computer Information Transaction Act (UCITA) are excluded from these Terms of Service. In no event shall any claim, action, or proceeding brought by either Party related in any way to the Site be commenced more than ______ years after the cause of action arose.</p>
                <br />
                ...
                <br />
                <p>Any dispute arising out of or in connection with this contract, including any question regarding its existence, validity, or termination, shall be referred to and finally resolved by the International Commercial Arbitration Court under the European Arbitration Chamber (Belgium, Brussels, Avenue Louise, 146)  according to the Rules of this ICAC, which, as a result of referring to it, is considered as the part of this clause. The number of arbitrators shall be __________. The seat, or legal place, of arbitration shall be __________. The language to be used in the arbitral proceedings shall be __________. The governing law of the contract shall be the substantive law of __________.</p>
                <br />
                <h4>Restrictions</h4>
                <br />
                ...
                <br />
                <h3 id="corrections"><a class="anchor" href="#corrections">Corrections</a></h3>
                <br />
                ...
                <br />
                <h3 id="disclaimer"><a class="anchor" href="#disclaimer">Diclaimer</a></h3>
                <br />
                ...
                <br />
                <h3 id="limitations-of-liability"><a class="anchor" href="#limitations-of-liability">Limitations of Liability</a></h3>
                <br />
                ...
                <br />
                <h3 id="idemnification"><a class="anchor" href="#idemnification">Idemnification</a></h3>
                <br />
                ...
                <h3 id="user-data"><a class="anchor" href="#user-data">User Data</a></h3>
                <br />
                ...
                <br />
                <h3 id="electronic-communications-transations-and-signatures"><a class="anchor" href="#electronic-communications-transations-and-signatures">Electronic Communications, Transactions, and Signatures</a></h3>
                <br />
                ...
                <br />
                <h3 id="california-users-and-residents"><a class="anchor" href="#california-users-and-residents">California Users and Residents</a></h3>
                <br />
                <p>If any complaint with us is not satisfactorily resolved, you can contact the Complaint Assistance Unit of the Division of Consumer Services of the California Department of Consumer Affairs in writing at 1625 North Market Blvd., Suite N 112, Sacramento, California 95834 or by telephone at (800) 952-5210 or (916) 445-1254.</p>
                <br />
                <h3 id="miscellaneous"><a class="anchor" href="#miscellaneous">Miscellaneous</a></h3>
                <br />
                <p>These Terms of Use and any policies or operating rules posted by us on the Site or in respect to the Site constitute the entire agreement and understanding between you and us. Our failure to exercise or enforce any right or provision of these Terms of Use shall not operate as a waiver of such right or provision. </p>
                <br />
                ...
                <br />
                <h3 id="contact-us"><a class="anchor" href="#contact-us">Contact Us</a></h3>
                <br />
                <p>In order to resolve a complaint regarding the Site or to receive further information regarding use of the Site, please contact us at contact@asatera.com </p>
                <br />
